...
//         return res
//           .status(404)
//           .json({ success: false, message: "DeepSubCategory not found" });
//       }

//       deepSubCategoryIds.push(deepSubCategory._id);
//       deepSubCategoryDetail = [deepSubCategory];
//       superSubCategoryDetail = await SuperSubCategory.findById(
//         deepSubCategory.super_sub_category_id
//       );
...
//         return res
//           .status(404)
//           .json({ success: false, message: "SuperSubCategory not found" });
//       }
...
//           success: false,
//           message: "No DeepSubCategories found under this SuperSubCategory",
//         });
//       }
...
//         success: false,
//         message:
//           'Invalid modelName. Use "deep-sub-category" or "super-sub-category"',
//       });
//     }
...
//         $addFields: {
//           trending_points: {
//             $ifNull: [{ $arrayElemAt: ["$trending.trending_points", 0] }, 0],
//           },
//         },
//       },
//     ];
...
//   try {
//     let { modelName, categoryName } = req.params;
//     // Extract 'type' from req.query
//     const { city, lat, lng, searchLocation, page = 1, type } = req.query;
...
//       // We check the type before proceeding to heavy user/address lookups
//       ...(type && type !== "products"
//         ? [
//             {
//               $match: {
...
// // Initialize an empty match object for location
// const locationMatch = {};
...
// if (searchLocation) {
//   // Use $and if city is also present to avoid overwriting
...
// // Add the match stage to the pipeline after the Address lookup
// if (Object.keys(locationMatch).length > 0) {
//   basePipeline.push({ $match: locationMatch });
// }

// // Note: If you use Geolocation ($near), it generally needs to be the
// // first stage of the pipeline. Since your primaryAddress comes from a
// // $lookup later, $near won't work easily here. Use $geoWithin instead
// // if you need to filter by lat/lng after a lookup.
...
//         $facet: {
//           totalCount: [{ $count: "count" }],
//           paginatedResults: [{ $skip: skip }, { $limit: pageSize }, { $project: finalProjection }],
//         },
//       },
