...
// exports.getBannerWithSellerInfo = async (req, res) => {
//   try {
...
//     switch (filter) {
//       case "today":
//         dateFilter = { created_at: { $gte: startOfToday } };
//         break;
//       case "yesterday":
//         dateFilter = { created_at: { $gte: startOfYesterday, $lt: endOfYesterday } };
//         break;
//       case "week":
...
//               }
//             },
//             { $sort: { createdAt: -1 } }, // latest company address
//             { $limit: 1 }
//           ],
//           as: "companyAddress"
//         }
...
//           banner_image: 1,
//           rectangle_logo: 1,
//           banner_image_approved: 1,
//           rectangle_logo_approved: 1,
//           created_at: 1,
...
//     // RECTANGLE BANNERS
//     // ============================================
//     const rectangleBanners = await Banner.aggregate([
//       {
//         $match: {
//           rectangle_logo: { $nin: [null, ""] }
//         }
//       },
//       ...commonPipeline
//     ]);
...
//     // PREMIUM BANNERS
//     // ============================================
//     const premiumBanners = await Banner.aggregate([
//       {
//         $match: {
//           banner_image: { $nin: [null, ""] }
//         }
//       },
//       ...commonPipeline
//     ]);
...
//       limit,
//       rectangle: {
//         total: rectangleBanners.length,
//         data: rectangleBanners
//       },
//       premium: {
//         total: premiumBanners.length,
//         data: premiumBanners
//       }
//     });
...
//     return res.status(500).json({
//       message: "Server error fetching banner details."
//     });
//   }
// };
...
//       return res.status(400).json({
//         success: false,
//         message: "Invalid type. Must be 'free' (rectangle logo) or 'paid' (premium banner)",
//         received: type,
//       });
//     }
...
//       friendlyName = 'Premium banner';
//       imageTypeForLog = 'banner_image';
//     } else { // 'free'
//       field = 'rectangle_logo_approved';
//       friendlyName = 'Rectangle logo';
//       imageTypeForLog = 'rectangle_logo';
//     }

//     // Safety: only toggle if the image actually exists
//     if (!banner[imageTypeForLog] || banner[imageTypeForLog].trim() === '') {
//       return res.status(400).json({
//         success: false,
//         message: `Cannot toggle approval — no ${friendlyName.toLowerCase()} exists`,
//       });
//     }

//     // ─── Toggle logic ──────────────────────────────────────────────
//     const wasApproved = banner[field];
//     banner[field] = !wasApproved;
//     banner.updated_at = new Date();

//     await banner.save();

//     // ─── Response ──────────────────────────────────────────────────
//     const action = banner[field] ? 'approved' : 'unverified';

//     return res.status(200).json({
//       success: true,
//       message: `${friendlyName} ${action} successfully`,
//       data: {
//         _id: banner._id,
//         banner_image: banner.banner_image,
...
//     });
//   } catch (error) {
//     console.error(`Toggle approval failed for banner ${req.params.id}:`, error);

//     return res.status(500).json({
//       success: false,
//       message: 'Failed to update banner approval status',
