...
//   try {
//     // 1️⃣ Get active paid Top Listing users
//     const topListingUsers = await TopListingPayment.find({
//       payment_status: "paid",
//       status: "Active",
//       expires_at: { $gt: new Date() },
//     }).select("user_id");

//     if (!topListingUsers.length) {
//       return res.json({
//         success: true,
//         data: [],
//       });
...
//     // 2️⃣ Loop each user
//     for (const entry of topListingUsers) {
//       const userId = entry.user_id;

//       // 🔹 NEW: Get user basic info
...
//       // 4️⃣ Get latest 2 ADMIN-VERIFIED products only
...
//       // 5️⃣ Get company address
//       const companyAddress = await Address.findOne({
//         user_id: userId,
//         address_type: "company",
//       }).lean();

//       // 6️⃣ Attach attributes to products
