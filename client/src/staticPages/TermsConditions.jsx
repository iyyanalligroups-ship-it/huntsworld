    ...
    <div className="bg-white relative text-black py-10 px-5 lg:px-20">
     ...
     These terms and conditions constitute a legally binding agreement between you and huntsworld governing your access to and use of huntsworld platform, including our website and mobile application. By accessing or using the platform, you acknowledge that you have read, understood and agreed to be bound by these terms. If you do not agree you must not use the platform.
      ...
      <div className="mb-8">
        ...
        <h3 className="text-xl font-medium mb-2">Platform Overview</h3>
        ...
        <h3 className="text-xl font-medium mb-2">User Eligibility</h3>
      ...
      <div className="mb-8">
        ...
        <h3 className="text-xl font-medium mb-2">Core Services</h3>
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
      ...
      <div className="mb-8">
        ...
        <h3 className="text-xl font-medium mb-2 mt-4">Verification</h3>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Subscriptions and Pricing</h2>
        <h3 className="text-xl font-medium mb-2">Subscription Models</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-medium mb-2 mt-4">Fee Changes</h3>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Trend Points System</h2>
        <p className="text-gray-700 mb-4">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Payments and Compliance</h2>
        <p className="text-gray-700 mb-4">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Grievance Redressal</h2>
        <p className="text-gray-700">
