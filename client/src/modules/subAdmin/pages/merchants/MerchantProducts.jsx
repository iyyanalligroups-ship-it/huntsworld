...
const MerchantProducts = () => {
  ...
  const [fetchMerchant, { isLoading }] = useLazyGetMerchantByEmailOrPhoneQuery();
  ...
  const handleEdit = (product) => {
    ...
    setIsModalOpen(true);
    console.log(product, "selected product for edit");
  };

  const handleDelete = (productId) => {
    console.log(productId, "selected product id for delete");
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            {/* Product Form */}
            {showForm && !isModalOpen && <MerchantProductForm editingProduct={null} />}
          </div>
        ...
        <Dialog open={isModalOpen} onOpenChange={handleModalClose}>
          <DialogContent className="max-w-2xl">
            ...
            <MerchantProductForm editingProduct={editingProduct} onClose={handleModalClose} />
          </DialogContent>
        </Dialog>
      </div>
    </div>
