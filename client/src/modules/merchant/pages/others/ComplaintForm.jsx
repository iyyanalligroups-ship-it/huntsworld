...
const ComplaintForm = ({ onCancel }) => {
  ...
  const handleChange = async (eOrChecked) => {
    if (typeof eOrChecked === 'boolean') {
      // Handle shadcn Checkbox (passes boolean directly)
      setFormData((prev) => ({ ...prev, agreement: eOrChecked }));
      return;
    }

    // Existing logic for other inputs
    const { name, value, type, checked, files } = eOrChecked.target;
  ...
  if (!user) {
    return (
      <div className="max-w-lg mx-auto text-center mt-12 px-4">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            <span className="text-blue-500">Hunts Wrold</span>{" "}
          ...
          {selectedOption && (
            <>
              {selectedOption.type === "type1" && (
                <>
                  <Textarea
                    ...
                    placeholder="e.g. Received damaged product during delivery"
                ...
                <>
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <Label htmlFor="ipr_type" className="sm:w-1/3 text-right">
                    ...
                    {formData.ipr_type === "Copyright Violation" && (
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        <Label htmlFor="copyright_title" className="sm:w-1/3 text-right">
                        ...
                        <Input
                          ...
                          className="w-full sm:w-2/3 border-2 border-slate-300"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <Label htmlFor="brand_name" className="sm:w-1/3 text-right">
                        Brand Name
                      </Label>
                      <Input
                        id="brand_name"
                        name="brand_name"
                        placeholder="e.g. Huntsworld Premium"
                        className="w-full sm:w-2/3 border-2 border-slate-300"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                      <Label htmlFor="related_attachment" className="sm:w-1/3 text-right">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                      <Label htmlFor="infringing_urls" className="sm:w-1/3 text-right mt-2">
                        Infringing URLs
                      </Label>
                      <Textarea
                        id="infringing_urls"
                        name="infringing_urls"
                        placeholder="e.g. https://example.com/product/123"
                        className="w-full sm:w-2/3 border-2 border-slate-300"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <Label htmlFor="court_order" className="sm:w-1/3 text-right">
                    ...
                    {formData.court_order === "Yes" && (
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="court_order_attachment" className="sm:w-1/3 text-right">
                          Upload Court Order
                        </Label>
                        <div className="flex flex-col gap-3 w-full sm:w-2/3">
                          <div className="relative w-full">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <Label htmlFor="you_are" className="sm:w-1/3 text-right">
                        You Are
                      </Label>
                      <Select
                        onValueChange={(value) =>
              ...
              {selectedOption.type === "type3" && (
                <>
                  {selectedOption.value === "buyer_complaint" && (
                    <>
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="buyer_name" className="sm:w-1/3 text-right">
                          Buyer Name
                        </Label>
                        <Input
                          id="buyer_name"
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="buyer_mobile" className="sm:w-1/3 text-right">
                          Buyer Mobile
                        </Label>
                        <Input
                          id="buyer_mobile"
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="product_name" className="sm:w-1/3 text-right">
                          Product Name
                        </Label>
                        <Input
                          id="product_name"
                  ...
                  {selectedOption.value === "supplier_complaint" && (
                    <>
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="supplier_name" className="sm:w-1/3 text-right">
                          Supplier Name
                        </Label>
                        <Input
                          id="supplier_name"
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="supplier_mobile" className="sm:w-1/3 text-right">
                          Supplier Mobile
                        </Label>
                        <Input
                          id="supplier_mobile"
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                        <Label htmlFor="supplier_product_name" className="sm:w-1/3 text-right">
                          Product Name
                        </Label>
                        <Input
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                    <Label htmlFor="attachment_1" className="sm:w-1/3 text-right">
                      Upload Attachments
                    </Label>
                    <div className="flex flex-col gap-3 w-full sm:w-2/3">
                      <div className="relative w-full">
              ...
              {selectedOption.type === "type2" && (
                <div className="flex items-center gap-4">
                  <Checkbox
                    ...
                    onCheckedChange={handleChange}  // Now passes boolean to handleChange
                  />
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-4">
                <Button className="bg-[#e03733] w-full sm:w-auto flex-1" onClick={handleSubmit}>
                  {isEditMode ? "Update Complaint" : "Submit Complaint"}
                </Button>
                <Button className="bg-gray-500 w-full sm:w-auto flex-1" onClick={onCancel}>
                  Cancel
                </Button>
              </div>
