...
import { Loader2, Wallet, Info, CheckCircle2, ShieldAlert, Banknote, AlertTriangle } from 'lucide-react';
...
// --- SOP COMPONENT (Derived from Backend Rules) ---
const WalletSOP = () => {
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden lg:sticky lg:top-6">
      ...
      <div className="p-5 space-y-6">
        ...
        {/* Rule 1: Fixed Amounts (From RESTRICTED_ROLES logic) */}
        <div className="relative pl-6 border-l-4 border-blue-600">
            ...
            <p className="text-xs text-gray-500 mt-1 mb-2">
              Security policy restricts withdrawals to specific block amounts only. You can select one of these tiers per request:
            </p>
        ...
        {/* Rule 2: INR Conversion (From amount_in_inr logic) */}
        <div className="relative pl-6 border-l-4 border-green-600">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Your points will be converted to <strong>INR (₹)</strong> based on the current point value. The equivalent cash amount will be processed by the admin.
            </p>
        </div>

        {/* Rule 3: Single Pending Request (From existingPending logic) */}
            ...
            <div className="flex items-start gap-2">
               ...
               <div>
                  ...
                  <p className="text-[11px] text-amber-700 mt-1 leading-relaxed">
                     You cannot raise a new request if you already have a <strong>"Pending"</strong> status redemption. Please wait for the admin to Approve or Reject your current request.
                  </p>
               </div>
            </div>
        </div>

        {/* Rule 4: Eligibility (From viewPoint < 2500 logic) */}
...
const WalletPage = ({ merchantId }) => {
  ...
  // Backend Rule: "User must have at least 2500 points to be eligible"
  const MIN_REDEEM_POINTS = 2500;

  // Backend Rule: Restricted roles can ONLY redeem 2500, 5000...
  // Therefore, the effective minimum withdrawal is 2500, not 500.
    ...
    <div className={`${isSidebarOpen ? 'p-6 lg:ml-56' : 'p-4 lg:ml-16'} transition-all duration-300`}>
      <div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          {/* LEFT SIDE: WALLET CARD (Flex-1 to take available space) */}
          <motion.div
                        ...
                        <div className="flex-1">
                           ...
                           {hasEnoughToRedeem && (
                              <p className="text-xs text-green-700 mt-1">
                                You can redeem points in blocks of 2500, 5000, 7500, or 10000.
                              </p>
                           )}
                        </div>
                    </div>
          ...
          {/* RIGHT SIDE: SOP SIDEBAR (Fixed width on desktop) */}
          <motion.div
