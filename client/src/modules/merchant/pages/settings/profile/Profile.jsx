            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="mt-1 border-2 border-slate-300 h-10 shadow-sm transition-all focus:ring-2 focus:ring-primary/20"
                />
              </div>
                    ...
                    <div className="mt-3 p-4 bg-primary/5 border border-primary/20 rounded-lg animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          className="h-9 text-center font-mono tracking-widest border-2 border-slate-300"
                          maxLength={6}
                        />
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                      <Input
                        ...
                        className={`pl-10 h-10 border-2 border-slate-300 shadow-sm transition-all focus:ring-2 focus:ring-primary/20 ${phoneError ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                      />
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger id="gender" className="border-2 border-slate-300 shadow-sm">
