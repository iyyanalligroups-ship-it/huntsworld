...
const SubDealerPage = () => {
  ...
  return (
    ...
    <h1 className="text-md border-1 border-[#0c1f4d] text-[#0c1f4d] bg-gray-100 p-2 rounded-r-2xl w-36 font-bold">Branches</h1>

      <div className="max-w-7xl mx-auto">
        <h4 className="text-xl pt-2 mb-6 text-[#0c1f4d]">
          ...
          <CardHeader>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Input
                ...
                className="max-w-xs border-2 border-slate-300"
              />
              ...
              <Button className="bg-[#0c1f4d] hover:bg-[#052570]" onClick={handleCreateNew}>Create New Sub Dealer</Button>
            </div>
          </CardHeader>
          <CardContent>
            {isLoading || merchantsLoading ? (
              ...
              <>
                <Table>
  <TableHeader>
    <TableRow className="group bg-[#0c1f4d] hover:bg-[#052570]">
