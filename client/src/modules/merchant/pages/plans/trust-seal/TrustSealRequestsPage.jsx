    ...
    <div className="p-6">
      ...
      <div className="mb-4 flex gap-4">
        <select
          ...
          className="p-2 border-2 border-slate-300 rounded shadow-sm bg-white focus:ring-2 focus:ring-[#0c1f4d] outline-none"
        >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Input
              placeholder="e.g. Verified through bank statement"
              value={notes}
