...
import { ArrowUpCircle, XCircle, IndianRupee, AlertCircle } from "lucide-react";
import Loader from '@/loader/Loader';

const TrendingPointsPlanManagement = ({ user, hasSubscription, subscriptionId, planCode, activeTrendingPointsPayment, pendingTrendingPointsPayment, onRefresh, setIsTrendingPointsProductOpen, pointRate }) => {
      ...
      <CardContent className="space-y-4">
        ...
        {planCode === "FREE" && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4 flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-amber-900">Paid Plan Required</h4>
              <p className="text-xs text-amber-700 mt-1">
                Trending points are only available for merchants on a paid subscription (Basic, Royal, or Premium). 
                Please upgrade your main subscription to access this feature.
              </p>
            </div>
          </div>
        )}
