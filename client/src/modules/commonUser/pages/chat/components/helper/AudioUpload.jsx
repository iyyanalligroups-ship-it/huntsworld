...
import { useUploadMessageImagesMutation } from "@/redux/api/MessageImagesApi"; // Adjust path
...
export default function AudioUpload({ senderId, receiverId, onUploadComplete }) {
  ...
  const [uploadChatAudio, { isLoading }] = useUploadMessageImagesMutation();
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await uploadChatAudio(formData).unwrap();
