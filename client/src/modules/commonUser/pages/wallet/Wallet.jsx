...
const WalletPage = ({ merchantId }) => {
  ...
  return (
    <div className={`pt-20 lg:pt-16 p-4 relative mb-8 lg:mb-0 transition-all duration-300`}>
      <Button
        type="button"
        onClick={() => navigate(-1)}
        variant="outline"
      ...
      <div className="max-w-7xl mx-auto mb-10 lg:mb-8">
              ...
              <Card className="border-0 shadow-lg overflow-hidden">
                ...
                <CardContent className="p-6 space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className={`p-4 rounded-xl border flex gap-3 ${hasEnoughToRedeem
                    ...
                    <Button
                      className={`w-full py-6 text-base font-semibold shadow-md transition-all ${canClickRedeem
