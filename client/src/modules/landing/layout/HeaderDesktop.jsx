    ...
    <header className="flex flex-col w-full z-50 bg-white shadow-md shrink-0">
      <div className="relative z-20 text-white bg-white flex justify-between items-center px-1 md:px-2 lg:px-4 xl:px-10 gap-1 lg:gap-2 p-1 border-b">
        ...
        <div className="flex items-center gap-2 text-[#1C1B1F]">
          ...
          {(role === "USER" ||
            ...
            <>
              ...
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem>
                    {role === "MERCHANT" && <GlobalNotificationBell />}
                  </NavigationMenuItem>
                </NavigationMenuList>
              </NavigationMenu>
            </>
          ...
          {/* News Dialog Button + Content */}
          <Button
            variant="outline"
            className="group relative gap-2 rounded-full border-gray-200 pl-3 pr-4 hover:border-indigo-300 hover:bg-indigo-50/50 transition-all duration-300 cursor-pointer"
