...
const MerchantWebsitePostRequirement = () => {
    ...
    <div>
      <div className="flex flex-col lg:flex-row justify-center p-4 gap-4">
        <motion.div
          ...
          className="w-full lg:max-w-3xl rounded-2xl p-4 sm:p-6"
        >
            ...
            <CardContent className="p-6">
              <form className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#0c1f4d] cursor-pointer hover:bg-[#0c1f4d]  hover:shadow-lg text-white py-2 rounded-md"
                >
...
export default MerchantWebsitePostRequirement;
