...
// const DeepSubCategoryList = ({ onEdit, setRefetch }) => {
...
//     const selectedItem = data?.find((item) => item._id === deleteId);
//     try {
//       if (selectedItem?.image) {
//         const imageName = selectedItem.image.split("/").pop();
//         await deleteImage(imageName).unwrap();
//       }
//       await deleteDeepSubCategory(deleteId);
//       await refetch();
//     } catch (error) {
...
//               <TableHead>Deep Sub-Category Image</TableHead>
...
//                   </TableCell>
//                   <TableCell>
//                     {item.super_sub_category_id?.super_sub_category_name}
//                   </TableCell>
//                   <TableCell>{item?.deep_sub_category_name}</TableCell>
//                   <TableCell>
//                     {
//                       <img
//                         src={encodeURI(item?.deep_sub_category_image)}
