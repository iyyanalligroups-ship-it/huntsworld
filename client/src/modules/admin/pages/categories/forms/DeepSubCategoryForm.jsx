...
// const DeepSubCategoryForm = ({ open, onClose, data }) => {
...
//   console.log(SuperSubCategories, "deep");
...
//     e.preventDefault();
//     if (isEdit) {
//       await updateDeepSubCategory({ id: data._id, ...formState });
//     } else {
//       await createDeepSubCategory(formState);
//     }
//     onClose();
//   };
...
//     const deep_sub_category_name = formState.deep_sub_category_image?.split("/").pop();
//     if (!deep_sub_category_name) return;

//     try {
//         await deleteImage(deep_sub_category_name).unwrap();
...
//               </SelectTrigger>
//               <SelectContent>
//                 {SuperSubCategories?.map((sub) => (
//                   <SelectItem key={sub._id} value={sub._id}>
//                     {sub.super_sub_category_name}
//                   </SelectItem>
//                 ))}
//               </SelectContent>
//             </Select>
