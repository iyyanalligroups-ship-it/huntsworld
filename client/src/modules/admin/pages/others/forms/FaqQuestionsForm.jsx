  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedQuestions) {
        ...
        toast.success(response.message || "Faq Question Updated Successfully");
      } else {
        const response = await createQuestion(formData).unwrap();
        toast.success(response.message || "Faq Question Created Successfully");
      }
      onSuccess();
      setFormData({
        topicId: "",
      ...
      toast.error(error?.data?.message || "Failed to save FAQ Question");
    }
  };
