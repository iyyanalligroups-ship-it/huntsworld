  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full bg-white rounded-2xl shadow-sm border border-gray-100">
        <Loader contained={true} label="Syncing Ledger..." />
      </div>
    );
  }

  return (
    <div className="container mx-auto space-y-10 py-6 md:py-10 bg-background min-h-screen">
      ...
      {isProcessingPayout && <Loader label="Processing Payout Request..." />}
    </div>
  );
};
