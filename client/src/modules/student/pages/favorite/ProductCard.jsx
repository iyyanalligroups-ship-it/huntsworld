...
const FavoriteCard = ({ favorite }) => {
  ...
  const removeId = favoriteId || favoriteDocumentId; // Both are the same in your API
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="p-3 bg-white rounded-full shadow-lg hover:bg-red-50 pointer-events-auto border border-red-200"
          >
