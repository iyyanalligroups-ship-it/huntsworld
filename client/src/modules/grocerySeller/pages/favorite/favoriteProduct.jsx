...
import { HeartOff, Plus, Phone, MessageCircle, Trash2, Heart } from "lucide-react";
...
const FavoriteProduct = () => {
  ...
  const {
    ...
    isFetching,
    refetch,
  } = useGetFavoritesUsersQuery(userId, { skip: !userId });
  ...
  if (!isAuthLoading && !userId) {
    return (
        <div className={`${isSidebarOpen ? "p-6 lg:ml-56" : "p-4 lg:ml-16"} mt-20 text-center`}>
    ...
    <>
      <div className={`${isSidebarOpen ? "p-6 lg:ml-56" : "p-4 lg:ml-16"}`}>
        <div className="p-2 relative">
          <h2 className="text-md mb-3 border border-[#0c1f4d] text-[#0c1f4d] bg-gray-100 p-2 rounded-r-2xl w-44 font-bold">
            Favorite Products
          </h2>
